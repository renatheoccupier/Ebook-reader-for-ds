...
> [!NOTE]
> If you don't want to touch the code then you can download `ikureader-6.5_modern.nds` and sandbox in [release](https://github.com/renatheoccupier/Epub-reader-for-ds/releases)
...
## Credits (sorry if i missing something or make wrong information)
